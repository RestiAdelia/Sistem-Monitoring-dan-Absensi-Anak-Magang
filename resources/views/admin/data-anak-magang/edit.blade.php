                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="jk" name="jk" required class="w-full rounded-xl border-slate-200 text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200 cursor-pointer text-slate-600 font-medium">
                                    ...
                                    <option value="Laki-laki" {{ old('jk', $intern->jk) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="Perempuan" {{ old('jk', $intern->jk) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="bidang" name="bidang"
                                    value="{{ old('bidang', $intern->bidang) }}"
                                    required
                                    placeholder="Contoh: Flutter Developer, Web Admin"
                                    class="w-full rounded-xl border-slate-200 text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 p-4 bg-slate-50 rounded-2xl border border-slate-200/60">
                            <div>
                                ...
                                <input type="date" id="tanggal_mulai_magang" name="tanggal_mulai_magang"
                                    ...
                                    required
                                    class="w-full rounded-xl border-slate-200 text-sm text-slate-700 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200 cursor-pointer" />
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select id="mentor_id" name="mentor_id" required
                                    class="w-full rounded-xl border-slate-200 text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200 cursor-pointer text-slate-600 font-medium">
                            ...
                            <div>
                                ...
                                <select id="status_magang" name="status_magang" required class="w-full rounded-xl border-slate-200 text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200 cursor-pointer text-slate-600 font-medium">
                                    <option value="Berjalan" {{ old('status_magang', $intern->status_magang) == 'Berjalan' ? 'selected' : '' }}>Berjalan</option>
                                    <option value="Selesai" {{ old('status_magang', $intern->status_magang) == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                    <option value="Diberhentikan" {{ old('status_magang', $intern->status_magang) == 'Diberhentikan' ? 'selected' : '' }}>Diberhentikan</option>
                                </select>
                            </div>
                        </div>
                    </div>
