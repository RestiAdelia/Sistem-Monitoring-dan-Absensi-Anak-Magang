<x-guest-layout>
    ...
    <div
        class="fixed inset-0 min-h-screen w-screen flex items-center justify-center bg-[#0f172a] font-sans antialiased px-4 sm:px-6 z-50 overflow-y-auto py-12">
        ...
        <div class="w-full max-w-md my-auto relative z-10">
            ...
            <div class="flex flex-col items-center mb-6 text-center">
                <div
                    class="p-2 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl mb-4 transform hover:scale-105 transition-transform duration-300 w-20 h-20 flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('build/assets/img/logo_mediatama.jpeg') }}" alt="Logo Mediatama"
                        class="w-full h-full object-contain filter drop-shadow-[0_0_4px_rgba(255,255,255,0.2)]">
                </div>
                <h1 class="text-xl font-black text-white tracking-wider uppercase">MONITORING MAGANG</h1>
                <p class="text-[10px] text-indigo-300/80 tracking-widest uppercase font-semibold mt-0.5">Portal
                    Registrasi Sistem</p>
            </div>
            ...
            <div
                ...
                <div class="mb-5 text-center">
                    <h2 class="text-lg font-bold text-white tracking-tight">Buat Akun Baru</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Silakan isi data diri Anda untuk mendaftar.</p>
                </div>
