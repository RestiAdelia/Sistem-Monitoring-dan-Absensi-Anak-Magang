    ...
    <div class="hidden lg:flex lg:flex-col lg:h-full">
        ...
        <div class="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
            <a href="{{ route('dashboard') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center transition-colors {{ request()->routeIs('dashboard') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-300' }}">
            ...
            <div class="pt-5 pb-1.5 px-4 flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em]">
                <span class="w-1 h-1 rounded-full bg-indigo-500/60"></span> Menu Admin
            </div>

            <a href="{{ route('admin.absensi.index') }}"
                class="group flex items-center gap-3 rounded-xl px-4 py-2.5 text-[13px] font-medium transition-all duration-300 hover:translate-x-1 {{ request()->routeIs('admin.absensi.*') ? 'bg-gradient-to-r from-indigo-500/20 via-blue-500/10 to-transparent text-white border-l-2 border-indigo-500 font-semibold' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}">
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('admin.absensi.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-300' }}">
            ...
            <a href="{{ route('admin.data-anak-magang.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('admin.data-anak-magang.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-300' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.174L10.74 3.697a1.65 1.65 0 012.52 0l6.48 6.477A1.65 1.65 0 0118.574 13h-1.148v7.25A1.75 1.75 0 0115.675 22h-7.35a1.75 1.75 0 01-1.75-1.75V13H5.426a1.65 1.65 0 01-1.165-2.826z"/></svg>
                </span>
                Data Anak Magang
            </a>
            ...
            <a href="{{ route('admin.data-mentor.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('admin.data-mentor.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-300' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </span>
                Data Mentor
            </a>
            ...
            <a href="{{ route('admin.graduation.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('admin.graduation.*') ? 'text-indigo-400' : 'text-slate-500 group-hover:text-slate-300' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.03 0 1.9.693 2.166 1.638m-7.377 0A48.536 48.536 0 0112 3c1.43 0 2.812.062 4.18.183"/></svg>
                </span>
            ...
            <a href="{{ route('mentor.attendance.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('mentor.attendance.*') ? 'text-white font-bold' : 'text-slate-500 group-hover:text-slate-300' }}">
            ...
            <a href="{{ route('mentor.interns.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('mentor.interns.*') ? 'text-white font-bold' : 'text-slate-500 group-hover:text-slate-300' }}">
            ...
            <a href="{{ route('mentor.logbooks.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('mentor.logbooks.*') ? 'text-white font-bold' : 'text-slate-500 group-hover:text-slate-300' }}">
            ...
            <a href="{{ route('mentor.tasks.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('mentor.tasks.*') ? 'text-white font-bold' : 'text-slate-500 group-hover:text-slate-300' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 6h12M6 10h12M6 14h8m-9 4h10V5.2c0-.663-.537-1.2-1.2-1.2H5.2C4.537 4 4 4.537 4 5.2V18z"/></svg>
                </span>
                Kelola Tugas
            </a>
            ...
            <a href="{{ route('mentor.grading.index') }}"
                ...
                <span class="inline-flex h-5 w-5 items-center justify-center {{ request()->routeIs('mentor.grading.*') ? 'text-white font-bold' : 'text-slate-500 group-hover:text-slate-300' }}">
        ...
        <div class="p-4 border-t border-slate-800 bg-black/10">
            <div class="flex items-center gap-3 p-2 rounded-xl hover:bg-white/5 transition-colors duration-200">
                <div class="h-9 w-9 rounded-xl bg-gradient-to-tr from-slate-800 to-slate-700 flex items-center justify-center font-bold text-slate-200 border border-slate-700/60 shadow-inner">
    ...
    <div class="lg:hidden bg-[#0B1329] border-b border-slate-800/40">
        <div class="flex items-center justify-between px-5 py-4">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
                ...
                <span class="font-extrabold text-white tracking-tight text-sm">{{ config('app.name', 'Laravel') }}</span>
            </a>
            <button @click="open = !open"
                ...
                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path x-show="!open" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M4 6h16M4 12h16M4 18h16" />
                    <path x-show="open" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
        </div>
        ...
        <div x-show="open"
            ...
            @if (Auth::user()->role === 'admin')
                ...
                <a href="{{ route('admin.users.index') }}" class="block rounded-xl px-4 py-2.5 text-[13px] font-medium text-slate-400">Kelola Pengguna</a>
                <a href="{{ route('admin.graduation.index') }}" class="block rounded-xl px-4 py-2.5 text-[13px] font-medium text-slate-400">Kelulusan & Sertifikat</a>
            @endif
